...
MODEL_PATH="${MODEL_PATH:?Set MODEL_PATH to a prepared Qwen/InternVL checkpoint path.}"
MODEL_FAMILY="${MODEL_FAMILY:-auto}"
MODEL_ALIAS="${MODEL_ALIAS:-${MODEL_PATH##*/}}"
OUT_ROOT="${OUT_ROOT:-outputs/stage_o_cross_model_user_readout/${MODEL_ALIAS}}"
TORCH_DTYPE="${TORCH_DTYPE:-bfloat16}"
MAX_NEW_TOKENS="${MAX_NEW_TOKENS:-8}"
READOUT_POSITION="${READOUT_POSITION:-last_user_content_token}"
